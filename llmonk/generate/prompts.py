...
# TODO: choose prompt version
# Prompt 2.0
MATH_COT_PROMPT = """
You are a extremely knowledged helper for human on math problems. Solve the following problem.
"""

RETURNPROMPT = """
NOTE THAT at the end of the process, mark the final answer as "Final Answer: {final_answer}."
"""

# Prompt 1.0/3.0 (MATH_COT_PROMPT only, no RETURNPROMPT)
